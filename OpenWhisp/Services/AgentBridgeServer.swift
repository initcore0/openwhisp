...
// The `AgentBridgeHost` protocol it drives now lives in AgentBridgeHost.swift so
// the LAN sync loopback harness can reuse it without dragging in the socket server.
