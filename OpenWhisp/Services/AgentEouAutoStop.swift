...
public struct AgentEouAutoStop {
    public struct Config: Equatable {
        ...
        public var settleMs: Int = 600
        public static let `default` = Config()

        public init(settleMs: Int = 600) {
    ...
    /// until then.
    public func shouldStop(now: Double) -> Bool {
