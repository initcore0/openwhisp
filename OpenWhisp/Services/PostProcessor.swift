...
public struct PostProcessContext {
    ...
    public var isLiveChunk: Bool

    public init(language: String, targetBundleID: String? = nil, isLiveChunk: Bool = false) {
...
public struct PostProcessorChain: PostProcessor {
    public let stages: [PostProcessor]

    public init(_ stages: [PostProcessor]) {
        self.stages = stages
    }
...
public protocol AsyncTextRefiner: Sendable {
...
public struct AIPostProcessor: PostProcessor {
    ...
    public let reclean: @Sendable (String) -> String
