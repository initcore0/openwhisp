...
public struct TranscriptionEntry: Codable, Identifiable, Equatable {
    public let id: UUID
    ...
    public var revertTarget: String? {
    ...
    public func reTranscribed(withNewText newText: String) -> TranscriptionEntry {
...
public enum TranscriptionHistoryStore {
    ...
    public static func load() -> [TranscriptionEntry] {
        JSONStore.load(from: fileURL, default: [], label: "TranscriptionHistoryStore")
    }

    public static func save(_ entries: [TranscriptionEntry]) {
